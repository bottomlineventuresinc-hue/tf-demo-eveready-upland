/* Template Factory - Eveready Electric live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-eveready-upland/';
  var LS_CHANGES = 'tf_eveready_change_log_v1';
  var LS_PURCHASED = 'tf_eveready_purchased_v1';
      ...
      apply: function () {
        if (heroLede) {
          heroLede.textContent =
            'Panel upgrades, residential electrical, and wiring across Upland and the Inland Empire. You get a fixed itemised quote before we start, Everitt as your named lead on site, and a twelve-month workmanship guarantee when we leave.';
        }
      }
    },
    {
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Everitt at Eveready Electric. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Everitt at Eveready Electric. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Eveready Electric. Hang tight.',
        delay,
        function () {
